        ...
        <div className="flex-1 overflow-y-auto">
          {sessions.slice(0, 8).map((session) => (
            <button
              ...
              className={`w-full p-3 hover:bg-gray-200 dark:hover:bg-gray-700 transition-colors relative ${
                currentSession?.id === session.id ? 'bg-blue-100 dark:bg-blue-900' : ''
              }`}
              title={session.title}
            >
    ...
    <div className="w-80 bg-gray-50 dark:bg-gray-800 border-r border-gray-200 dark:border-gray-700 flex flex-col h-full">
      ...
      <div className="p-4 border-b border-gray-200 dark:border-gray-700">
        ...
        <button
          ...
          className="w-full flex items-center justify-center space-x-2 bg-blue-600 text-white px-4 py-2 rounded-lg hover:bg-blue-700 disabled:bg-gray-300 dark:disabled:bg-gray-600 disabled:cursor-not-allowed transition-colors"
        >
              ...
              <div
                ...
                className={`group relative p-3 mb-2 rounded-lg cursor-pointer transition-all ${
                  currentSession?.id === session.id
                    ...
                    : 'bg-white dark:bg-gray-700 hover:bg-gray-100 dark:hover:bg-gray-600 border border-gray-200 dark:border-gray-600 hover:border-gray-300 dark:hover:border-gray-500'
                }`}
              >
                  ...
                  <button
                    ...
                    className={`ml-2 p-1 rounded transition-all ${
                      deleteConfirm === session.id
                        ...
                        : 'opacity-0 group-hover:opacity-100 hover:bg-red-50 dark:hover:bg-red-900/30 text-gray-400 dark:text-gray-500 hover:text-red-500 dark:hover:text-red-400'
                    }`}
